...
const { isLogged, onlyUsers, onlyUsersAdmin, adminOrCurrentUser } = require('../app/middlewares/session')
...
routes.put('/:id', UserValidator.update, adminOrCurrentUser, UserController.put) // Editar um usuário
routes.get('/:id/edit', UserValidator.profile, adminOrCurrentUser, UserController.edit) // Mostrar o formulário de edição de um usuário
