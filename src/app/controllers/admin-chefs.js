...
exports.index = function(req, res) {
    ...
    return res.render('area-adm/recipes/index', { recipes: data.recipes })
}
...
exports.show = function(req, res) {
    ...
    return res.render('area-adm/recipes/recipe', { recipe: foundRecipe })
}
exports.edit = function(req, res) {
    ...
    if (!foundRecipe)
        return res.send('Receita not Found')
    return res.render('area-adm/recipes/edit', { recipe: foundRecipe })
}
